    ...
    <div className="flex flex-col items-center gap-4 select-none">
      ...
      <div
        ...
        style={{
          ...
          boxShadow: hover
            ? `0 24px 56px rgba(0,0,0,0.55), 0 0 0 2px ${catColor}55`
      ...
      >
        ...
        {/* Card content */}
        <div className="relative z-0 p-5 flex flex-col gap-3.5" style={{ height: "100%" }}>
          ...
          <div className="flex items-center gap-2">
            <div className="flex-1 h-px" style={{ backgroundColor: catColor + "33" }} />
